...
[![Test](https://github.com/phuongnh-aip/pdfcpu/workflows/Test/badge.svg)](https://github.com/phuongnh-aip/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/phuongnh-aip/pdfcpu?status.svg)](https://pkg.go.dev/github.com/phuongnh-aip/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/phuongnh-aip/pdfcpu)](https://goreportcard.com/report/github.com/phuongnh-aip/pdfcpu)
...
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/phuongnh-aip/pdfcpu/releases)
...
* [API tests](https://github.com/phuongnh-aip/pdfcpu/tree/master/pkg/api/test)
* [API samples](https://github.com/phuongnh-aip/pdfcpu/tree/master/pkg/samples) 
* CLI usage: `$ pdfcpu help cmd`

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/phuongnh-aip/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/phuongnh-aip/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/phuongnh-aip/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/phuongnh-aip/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/phuongnh-aip/pdfcpu
...
```
$ go install github.com/phuongnh-aip/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/phuongnh-aip/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/phuongnh-aip/pdfcpu/discussions) first or [create](https://github.com/phuongnh-aip/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/phuongnh-aip/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
